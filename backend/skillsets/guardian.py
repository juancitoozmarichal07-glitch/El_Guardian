...
# En tu archivo guardian.py, reemplaza la función _gestionar_diseno por esta:
...
def _gestionar_diseno(self, estado_actual, comando):
    ...
    # --- PASO 2: ARRANQUE (¡CON LÓGICA DE RULETA CORREGIDA!) ---
    ...
    # --- PASO 4: DURACIÓN (¡TAMBIÉN CON LÓGICA DE RULETA!) ---
        ...
        if len(opciones) == 1:
            ...
            # Como este es el último paso, forjamos el contrato directamente.
            contrato_texto = (f"**CONTRATO FORJADO**\n--------------------\n**Misión:** {datos_plan.get('mision', 'N/A')}\n**Arranque:** {datos_plan.get('arranque', 'N/A')}\n**Duración:** {datos_plan.get('duracion', 'N/A')}\n--------------------\nContrato sellado. ¿Siguiente misión?")
            nuevo_estado = {"modo": "libre"}
            return {"nuevo_estado": nuevo_estado, "mensaje_para_ui": contrato_texto}
        else:
